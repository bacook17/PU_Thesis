...
\abstract{How are baryons distributed in the universe? Where, and in
  ...
  distribution, and the dark matter, stellar, and gaseous components
  of groups, clusters, and large-scale structure may comprised only of
  the contributions from individual galaxies which fell into these
  larger systems. Baryons, which initially fell into the gravitational
  potentials formed by dark matter, have not been removed
  significantly from these systems, but remain in roughly the cosmic
  fraction in galaxies, groups, clusters, and large-scale structure.}
