...
\sim 1.4 \power{14}$ to $1.0 \power{15} \Msun$, with median $\Mvir =
...
that \fg{} increases from \rfive{} to \rtwo{} ($\fg(<\rfive) \sim
0.12$ for CC clusters). 

\textbf{\citet{Umetsu2009}} (U09) observed the ICM of four very massive
($\Mvir \gsim 1\power{15}$ \Msun, $\textrm{kT} \sim 9$ -- $10$ \keV)
...
large radius, the full equation for the gas fraction can be simplified
using these model distributions:
\begin{align}
\fg(<\textrm{r}) = \frac{\textrm{M}_{gas}}{\textrm{M}_{tot}} &=
\frac{\int_0^r 4\pi{}r^2dr\rho_{gas}(\textrm{r}')}{\int_0^r
  4\pi{}r^2dr\rho_{m}(\textrm{r}')} \nonumber \\ & \propto
\frac{\textrm{r}^{-\alpha_{gas}}}{\textrm{r}^{-\alpha_{m}}}\nonumber\\ &
\propto \textrm{r}^{\alpha_{m} - \alpha_{tot}}. \nonumber
\end{align}
