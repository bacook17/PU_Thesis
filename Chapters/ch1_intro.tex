...
Rich galaxy clusters have been observed to have halo masses of
$10^{14}$ -- $10^{15} $ M$_\odot$ \citep{Mandelbaum2008}, and halo radii
of around 1 -- 3 Mpc \citep{Vikhlinin2006}. The self-similarity of
halos results in a fairly constant relation between M and r at various
overdensities. For example \citep{Rasheed2011}:
\begin{equation}
